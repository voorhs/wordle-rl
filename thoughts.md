...
- Первым делом: улучшить имеющееся
    1. Увеличить буфер и пиклить его после каждого обучения
    2. Сменить стратегию обучения и тестирования
    3. Использование 120-модели в качестве бекбона для 4767-модели
- Вторым делом: бенчмарки
    2. Слова из 6-10 букв
- Третьим делом: исправить выпуклое решение
    1. Обучить эмбеддинги по хорошему:
        - негатив семплинг
        - скалярное произведение
        - сигмоида
        - поменьше чем 10 компонент?
- Четвёртым делом: distributional RL
